...
const MethodsOverviewSlide = () => {
  ...
  const methods = [
    {
      ...
      examples: ['Integrated Gradients (ICML 2017)', 'GIM Framework', 'Captum LLMAttribution']
    },
    {
      ...
      examples: ['ContextCite (NeurIPS 2024)', 'CAMAB', 'SelfCite']
    },
    {
      ...
      examples: ['Anthropic Attribution Graphs', 'circuit-tracer', 'TransformerLens']
    },
    {
      ...
      examples: ['LoGra (6,500x speedup)', 'RepSim', 'DDA (93.49% AUC)']
    },
    {
      ...
      examples: ['Self-RAG (55.8% on PopQA)', 'START (+25.13%)', 'LongCite']
    }
  ];
  ...
  return (
    <Slide
      className="bg-white"
      references={['integratedGradients', 'contextCite', 'anthropicBiology', 'logra', 'selfRag']}
    >
        ...
        <div className="pt-3 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            {method.examples.map((ex, i) => (
              <span key={i} className="px-3 py-1.5 rounded-lg bg-white border border-gray-200 text-xs text-gray-700">
                {ex}
              </span>
            ))}
          </div>
