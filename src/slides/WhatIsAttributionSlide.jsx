      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200">
          ...
          <div className="mt-3 text-xs text-gray-500">
            Distinction introduced in <Cite refKey="contextCite" />
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
          ...
          <div className="mt-3 text-xs text-gray-500">
            Critical for debugging in <Cite refKey="contextCite" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
          <div className="bg-white rounded-xl p-4 border border-gray-200">
            ...
            <div className="text-gray-500 text-xs mt-1">ALCE benchmark shows GPT-4 lacks citation support ~50% on ELI5 <Cite refKey="alce" /></div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-gray-200">
            <CheckCircle className="w-5 h-5 text-green-500 mb-2" />
            <div className="font-medium text-gray-900">Debug Agent Behavior</div>
            <div className="text-gray-500 text-xs mt-1">Trace multi-step reasoning with circuit analysis <Cite refKey="anthropicBiology" /></div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-gray-200">
            <CheckCircle className="w-5 h-5 text-green-500 mb-2" />
            <div className="font-medium text-gray-900">Detect Hallucinations</div>
            <div className="text-gray-500 text-xs mt-1">Semantic entropy achieves 89-91% detection accuracy <Cite refKey="semanticEntropy" /></div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-gray-200">
            <CheckCircle className="w-5 h-5 text-green-500 mb-2" />
