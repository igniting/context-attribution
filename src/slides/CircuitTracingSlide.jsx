...
import { Slide, AnimatedNode, AnimatedLine, Cite } from '../components';
    ...
    <Slide className="bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <div className="grid md:grid-cols-3 gap-3 mb-4">
        <div className="bg-white rounded-lg p-3 border border-purple-200">
          ...
          <div className="text-xs text-gray-600">Interpretable features via sparse autoencoders <Cite refKey="anthropicBiology" /></div>
        </div>
        <div className="bg-white rounded-lg p-3 border border-purple-200">
        ...
        <div className="bg-white rounded-lg p-3 border border-purple-200">
          ...
          <div className="text-xs text-gray-600">Target for significant interpretability progress <Cite refKey="darioInterpretability" /></div>
        </div>
      </div>
      ...
      <div className="bg-purple-900 rounded-xl p-4 text-white">
        <p className="flex items-start gap-3 text-sm">
          ...
          <span>
            <strong className="text-purple-200">Open-source tools</strong> <Cite refKey="anthropicCircuitTools" />: 
            Circuit-tracer available for Gemma-2-2b and Llama-3.2-1b. TransformerLens <Cite refKey="transformerLens" /> 
            provides activation patching with 2.8k stars on GitHub. Interactive frontend at 
