    ...
    <Slide className="bg-white">
      ...
      <div className="grid md:grid-cols-3 gap-3 mb-4">
        <div className="bg-emerald-50 rounded-lg p-3 border border-emerald-200">
          ...
          <div className="text-emerald-600 text-xs mt-1">vs 24.4% baseline <Cite refKey="selfRag" /></div>
        </div>
        <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
          ...
          <div className="text-purple-600 text-xs mt-1">No human annotations needed <Cite refKey="start" /></div>
        </div>
        <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
          ...
          <div className="text-blue-600 text-xs mt-1">Over GPT-4o baseline <Cite refKey="longCite" /></div>
        </div>
      </div>
