...
const FaithfulnessSlide = () => {
  const [activeMethod, setActiveMethod] = useState('ragas');
  ...
  return (
    <Slide className="bg-gradient-to-br from-orange-50 via-white to-red-50">
      ...
      <p className="text-lg text-gray-600 mb-4">
        Detecting when generated text is not grounded in retrieved context
      </p>
      ...
      {/* RAGAS Pipeline */}
      {activeMethod === 'ragas' && (
        <div className="bg-white rounded-xl p-5 border border-orange-200 shadow-sm mb-4">
          <h3 className="text-lg font-bold text-gray-900 mb-4">RAGAS Faithfulness Pipeline</h3>
          
          <div className="grid md:grid-cols-4 gap-3 mb-4">
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-100 text-center">
              <div className="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">1</div>
            ...
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-100 text-center">
              <div className="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">2</div>
            ...
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-100 text-center">
              <div className="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">3</div>
            ...
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-100 text-center">
              <div className="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center mx-auto mb-2 text-sm font-bold">4</div>
        ...
        <div className="space-y-4 mb-4">
          <div className="bg-red-50 rounded-xl p-5 border border-red-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-red-800 mb-2">The Semantic Illusion Problem (2025)</h3>
      ...
      {activeMethod === 'comparison' && (
        <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm mb-4">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Faithfulness Detection Methods Compared</h3>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-2 px-3 font-semibold text-gray-700">Approach</th>
                  <th className="text-center py-2 px-3 font-semibold text-gray-700">Real FPR</th>
                  <th className="text-left py-2 px-3 font-semibold text-gray-700">Trade-off</th>
                </tr>
              </thead>
              <tbody className="text-xs">
                <tr className="border-b border-gray-100">
                  <td className="py-2 px-3 font-medium">Embedding Similarity</td>
                  <td className="py-2 px-3 text-gray-600">Cosine distance threshold</td>
                  <td className="py-2 px-3 text-center"><span className="text-red-600 font-bold">100%</span></td>
                  <td className="py-2 px-3 text-gray-600">Fast but unreliable</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-2 px-3 font-medium">NLI (TRUE)</td>
                  <td className="py-2 px-3 text-gray-600">T5-11B entailment</td>
                  <td className="py-2 px-3 text-center"><span className="text-orange-600 font-bold">~15%</span></td>
                  <td className="py-2 px-3 text-gray-600">Good accuracy, moderate cost</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-2 px-3 font-medium">GPT-4 Reasoning</td>
                  <td className="py-2 px-3 text-gray-600">Chain-of-thought verification</td>
                  <td className="py-2 px-3 text-center"><span className="text-green-600 font-bold">7%</span></td>
                  <td className="py-2 px-3 text-gray-600">Best accuracy, highest cost</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-2 px-3 font-medium">Semantic Entropy</td>
                  <td className="py-2 px-3 text-gray-600">Sample multiple outputs</td>
                  <td className="py-2 px-3 text-center"><span className="text-green-600 font-bold">9-11%</span></td>
                  <td className="py-2 px-3 text-gray-600">89-91% detection accuracy</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      {/* Key Takeaway */}
      <div className="bg-orange-900 rounded-xl p-4 text-white">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <span className="text-orange-100 ml-1">
              ...
              Production systems should use reasoning-based verification (NLI or LLM) despite higher computational cost.
            </span>
          </div>
        </div>
      </div>
